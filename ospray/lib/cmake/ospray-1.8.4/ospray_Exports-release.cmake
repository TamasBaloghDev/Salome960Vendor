...
set_target_properties(ospray::ospray_common PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray_common.so.1.8.4"
  IMPORTED_SONAME_RELEASE "libospray_common.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray_common )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray_common "${_IMPORT_PREFIX}/lib/libospray_common.so.1.8.4" )
...
set_target_properties(ospray::ospray PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray.so.1.8.4"
  IMPORTED_SONAME_RELEASE "libospray.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray "${_IMPORT_PREFIX}/lib/libospray.so.1.8.4" )
...
set_target_properties(ospray::ospray_module_ispc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libospray_module_ispc.so.1.8.4"
  IMPORTED_SONAME_RELEASE "libospray_module_ispc.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS ospray::ospray_module_ispc )
list(APPEND _IMPORT_CHECK_FILES_FOR_ospray::ospray_module_ispc "${_IMPORT_PREFIX}/lib/libospray_module_ispc.so.1.8.4" )
