...
foreach(_expectedTarget vtkm_vectorization_flags vtkm_compiler_flags vtkm_developer_flags vtkm_diy vtkm_lodepng vtkm_loguru vtkm_optionparser vtkm_taotuple vtkm_lcl vtkm_cont vtkm_worklet vtkm_filter vtkm_source)
...
set_target_properties(vtkm_compiler_flags PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/paraview-5.8/vtkvtkm/vtk-m"
)
...
set_target_properties(vtkm_developer_flags PROPERTIES
  INTERFACE_COMPILE_OPTIONS "\$<\$<COMPILE_LANGUAGE:CXX>:-Wall;-Wcast-align;-Wchar-subscripts;-Wextra;-Wpointer-arith;-Wformat;-Wformat-security;-Wshadow;-Wunused;-fno-common;-Wfloat-conversion;-Wodr>"
)
...
set_target_properties(vtkm_diy PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_11"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/paraview-5.8/vtkvtkm/vtk-m/vtkm/thirdparty/diy"
)
...
set_target_properties(vtkm_lodepng PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/paraview-5.8/vtkvtkm/vtk-m/vtkm/thirdparty/lodepng"
)
...
set_target_properties(vtkm_loguru PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_11"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/paraview-5.8/vtkvtkm/vtk-m/vtkm/thirdparty/loguru"
...
set_target_properties(vtkm_optionparser PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/paraview-5.8/vtkvtkm/vtk-m/vtkm/thirdparty/optionparser"
)
...
set_target_properties(vtkm_taotuple PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_11"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/paraview-5.8/vtkvtkm/vtk-m/vtkm/thirdparty/taotuple"
)
...
set_target_properties(vtkm_lcl PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_11"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/paraview-5.8/vtkvtkm/vtk-m/vtkm/thirdparty/lcl/vtkmlcl"
)
...
set_target_properties(vtkm_cont PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:>;vtkm_compiler_flags;vtkm_taotuple;vtkm_optionparser;vtkm_diy;vtkm_lcl;\$<LINK_ONLY:vtkm_loguru>"
)
...
add_library(vtkm_filter STATIC IMPORTED)

set_target_properties(vtkm_filter PROPERTIES
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:>;vtkm_worklet"
)
