...
if [ "$1" == "" ]; then
  if [ "$2" == "64" ]; then
    ...
    export TCL_DIR=""
    export TK_DIR=""
    export FREETYPE_DIR="/home/tamas/Development/STH/vendor/Salome960Vendor/freetype/lib"
    export FREEIMAGE_DIR="/home/tamas/Development/STH/vendor/Salome960Vendor/freeimage/lib:"
    export TBB_DIR=""
    export VTK_DIR=""
    export FFMPEG_DIR=""
