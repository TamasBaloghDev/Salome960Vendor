...
if [ "${CASROOT}" == "" ]; then
  export CASROOT="/home/tamas/Development/STH/vendor/Salome960Vendor/CAS"
fi

# ----- Define path to 3rdparty products -----
export THIRDPARTY_DIR="/volatile/salome/jenkins/workspace/Salome_master_UB18_pilote/SALOME-9.6.0-UB18.04/SOURCES/CAS"
