...
set(Qt5QuickWidgets_VERSION_STRING 5.9.1)
...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/QtQuickWidgets/5.9.1"
        "${_qt5QuickWidgets_install_prefix}/include/QtQuickWidgets/5.9.1/QtQuickWidgets"
    )
    ...
    _populate_QuickWidgets_target_properties(RELEASE "libQt5QuickWidgets.so.5.9.1" "" )
