...
set(Qt5Quick_VERSION_STRING 5.9.1)
...
if (NOT TARGET Qt5::Quick)
    ...
    set(Qt5Quick_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick_install_prefix}/include/QtQuick/5.9.1"
        "${_qt5Quick_install_prefix}/include/QtQuick/5.9.1/QtQuick"
    )
    ...
    _populate_Quick_target_properties(RELEASE "libQt5Quick.so.5.9.1" "" )
