...
IF(NOT batch AND NOT LibBatch_BINARY_DIR)
  INCLUDE("${PACKAGE_PREFIX_DIR}/share/cmake/libbatch/LibBatchTargets.cmake")
ENDIF()   
...
SET_AND_CHECK(PTHREAD_ROOT_DIR_EXP "/usr")

IF(LIBBATCH_PYTHON_WRAPPING)
  SET_AND_CHECK(LIBBATCH_PYTHONPATH "${PACKAGE_PREFIX_DIR}/lib/python3.6/site-packages")
  SET_AND_CHECK(PYTHON_ROOT_DIR_EXP "/home/tamas/Development/STH/vendor/Salome960Vendor/Python")
  SET_AND_CHECK(SWIG_ROOT_DIR_EXP "/home/tamas/Development/STH/vendor/Salome960Vendor/swig")
ENDIF()
